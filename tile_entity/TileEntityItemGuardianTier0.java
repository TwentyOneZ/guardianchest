...
public class TileEntityItemGuardianTier0 extends TileEntityChest {
	
    private ItemStack[] chestContents = new ItemStack[99];
    /** Determines if the check for adjacent chests has taken place. */
    public boolean adjacentChestChecked;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityItemGuardianTier0 adjacentChestZNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityItemGuardianTier0 adjacentChestXPos;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityItemGuardianTier0 adjacentChestXNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityItemGuardianTier0 adjacentChestZPos;
    ...
    public TileEntityItemGuardianTier0()
    {
        this.cachedChestType = -1;
    }

    @SideOnly(Side.CLIENT)
    public TileEntityItemGuardianTier0(int p_i2350_1_)
    {
