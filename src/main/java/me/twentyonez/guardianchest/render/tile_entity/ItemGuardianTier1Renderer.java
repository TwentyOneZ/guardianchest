...
import me.twentyonez.guardianchest.tile_entity.TileEntityItemGuardianTier1;
...
public class ItemGuardianTier1Renderer extends TileEntitySpecialRenderer
{
    private static final ResourceLocation field_147505_d = new ResourceLocation("guardianchest:textures/items/guardianTier1.png");
    private static final ResourceLocation field_147504_g = new ResourceLocation("guardianchest:textures/items/guardianTier1.png");
    private ModelChest field_147510_h = new ModelChest();
    private ModelChest field_147511_i = new ModelLargeChest();
    private boolean field_147509_j;
    private static final String __OBFID = "CL_00000965";

    public ItemGuardianTier1Renderer()
    {
    ...
    public void renderTileEntityAt(TileEntityItemGuardianTier1 p_147502_1_, double p_147502_2_, double p_147502_4_, double p_147502_6_, float p_147502_8_)
    {
        int i;
    ...
    {
        this.renderTileEntityAt((TileEntityItemGuardianTier1)p_147500_1_, p_147500_2_, p_147500_4_, p_147500_6_, p_147500_8_);
    }
}
