...
public class TileEntityItemGuardianTier2 extends TileEntityChest {
	
    private ItemStack[] chestContents = new ItemStack[99];
    /** Determines if the check for adjacent chests has taken place. */
    public boolean adjacentChestChecked;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityItemGuardianTier2 adjacentChestZNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityItemGuardianTier2 adjacentChestXPos;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityItemGuardianTier2 adjacentChestXNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityItemGuardianTier2 adjacentChestZPos;
    ...
    public TileEntityItemGuardianTier2()
    {
        this.cachedChestType = -1;
    }

    @SideOnly(Side.CLIENT)
    public TileEntityItemGuardianTier2(int p_i2350_1_)
    {
