...
public class TileEntityItemGuardianTier1 extends TileEntityChest {
	
    private ItemStack[] chestContents = new ItemStack[99];
    /** Determines if the check for adjacent chests has taken place. */
    public boolean adjacentChestChecked;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityItemGuardianTier1 adjacentChestZNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityItemGuardianTier1 adjacentChestXPos;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityItemGuardianTier1 adjacentChestXNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityItemGuardianTier1 adjacentChestZPos;
    ...
    public TileEntityItemGuardianTier1()
    {
        this.cachedChestType = -1;
    }

    @SideOnly(Side.CLIENT)
    public TileEntityItemGuardianTier1(int p_i2350_1_)
    {
